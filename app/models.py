...
class Bolsa(models.Model):
    PAISES_CHOICES = (("afeganistao", "Afeganistão"),("africa_do_sul", "África do Sul"),("albania","Albânia"),
                      ...
                      ("quiribati", "Quiribáti"), ("reino_unido", "Reino Unido"), ("republica_ca", "República Centro-Africana"),
                      ("republica_checa", "República Checa"), ("republica_dc", "República Democrática do Congo"), ("republica_d", "República Dominicana"),
                      ("romenia", "Roménia"), ("ruanda", "Ruanda"), ("russia", "Rússia"),
                      ("salomao", "Salomão"), ("salvador", "Salvador"), ("samoa", "Samoa"),
                      ("santa_lucia", "Santa Lúcia"), ("sao_cristovao", "São Cristóvão e Neves"), ("sao_marinho", "São Marinho"),
                      ...
                      ("siria", "Síria"), ("angola", "Somália"), ("sri_Lanca", "Sri Lanca"), ("suazilandia", "Suazilândia"),
...
class Pesquisador(models.Model):
    ...
    nome = models.CharField(null=False, verbose_name="Nome")
